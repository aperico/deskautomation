...
# OUTPUT: results/all_rules_summary.md (comprehensive pass/fail/skip report)
...
- **Summary Report:** `results/all_rules_summary.md` generated by `rules-all` command with detailed results table and pass/fail counts

**Current Coverage:** 80 total rules, 51 automated (64%)
- 🤖 Automated Scripts: 51 rules with pattern matching, AST analysis, and tool integration
- 🔍 Code Review: 29 rules requiring human judgment
- ⚠️ **Deprecated:** RULE-047 (test coverage via gcov - no longer performed)
...
| 1.2 | 2026-02-22 | A. Perico + A.I. | Performance optimizations, RULE-047 deprecation, summary report improvements |
...
| RULE-041 | R10.5 | MISRA C:2012 compliance (pattern-based) | 🤖 | [rule_RULE-041_R10_5_misra_compliance.py](../toolchain/rules/rule_RULE-041_R10_5_misra_compliance.py) |
...
| RULE-047 | R13.1 | ~~Unit test coverage~~ (DEPRECATED - gcov not used) | ⚠️ | (removed) |
...
| RULE-058 | MISRA-8.3 | Consistent function declarations (cppcheck) | 🤖 | [rule_RULE-058_MISRA_8_3_function_consistency.py](../toolchain/rules/rule_RULE-058_MISRA_8_3_function_consistency.py) |

...
class DeskControllerUnit : public ::testing::Test {
protected:
 ...
 */
TEST_F(DeskControllerUnit, Unit_IdleHandler_SwitchUp_TransitionsToMoveUp) {
 ...
 * @focus handle_idle_test() function behavior
 */
TEST_F(DeskControllerUnit, Unit_IdleHandler_SwitchDown_TransitionsToMoveDown) {
    SetInternalState(0); // APP_STATE_IDLE
 ...
 * @focus handle_idle_test() function behavior
 */
TEST_F(DeskControllerUnit, Unit_IdleHandler_SwitchOff_RemainsIdle) {
    SetInternalState(0); // APP_STATE_IDLE
    inputs.switch_state = SWITCH_STATE_OFF;
 ...
 */
TEST_F(DeskControllerUnit, Unit_IdleHandler_NullOutputs_HandlesSafely) {
    SetInternalState(0); // APP_STATE_IDLE
    inputs.switch_state = SWITCH_STATE_UP;
 ...
 */
TEST_F(DeskControllerUnit, Unit_MoveUpHandler_ContinuesMotorUp) {
 ...
 */
TEST_F(DeskControllerUnit, Unit_MoveUpHandler_SwitchToOff_StopsMotor) {
    SetInternalState(1); // APP_STATE_MOVE_UP
    inputs.switch_state = SWITCH_STATE_OFF;
 ...
 */
TEST_F(DeskControllerUnit, Unit_MoveUpHandler_SwitchToDown_StartsDownwell) {
    SetInternalState(1); // APP_STATE_MOVE_UP
    inputs.switch_state = SWITCH_STATE_DOWN;
 ...
 */
TEST_F(DeskControllerUnit, Unit_MoveUpHandler_TimeoutDetection) {
 ...
 */
TEST_F(DeskControllerUnit, Unit_MoveDownHandler_ContinuesMotorDown) {
 ...
 */
TEST_F(DeskControllerUnit, Unit_MoveDownHandler_SwitchToOff_StopsMotor) {
    SetInternalState(2); // APP_STATE_MOVE_DOWN
    inputs.switch_state = SWITCH_STATE_OFF;
 ...
 */
TEST_F(DeskControllerUnit, Unit_MoveDownHandler_SwitchToUp_StartsUpwell) {
    SetInternalState(2); // APP_STATE_MOVE_DOWN
    inputs.switch_state = SWITCH_STATE_UP;
 ...
 * @focus Safety: SWE-REQ-018 (Movement Timeout)
 */
TEST_F(DeskControllerUnit, Unit_MoveDownHandler_TimeoutDetection) {
    unsigned long start_time = 0;
 ...
 */
TEST_F(DeskControllerUnit, Unit_DwellHandler_WaitsForDwellPeriod) {
 ...
 */
TEST_F(DeskControllerUnit, Unit_DwellHandler_ExitsDwellOnTimeout) {
    DeskApp_set_time_ms(0);
    SetInternalState(3, 0, 0); // APP_STATE_DWELL, dwellStartMs = 0
    inputs.switch_state = SWITCH_STATE_DOWN;
 ...
 */
TEST_F(DeskControllerUnit, Unit_DwellHandler_SwitchReleaseExitsDwell) {
 ...
 */
TEST_F(DeskControllerUnit, Unit_DwellHandler_PreservesDwellStartTime) {
 ...
 */
TEST_F(DeskControllerUnit, Unit_StateMachine_UpMoveSequence) {
    // Start in IDLE
    SetInternalState(0);
    inputs.switch_state = SWITCH_STATE_UP;
    handle_idle_test(&inputs, &outputs);
 ...
 */
TEST_F(DeskControllerUnit, Unit_StateMachine_DirectionReversal) {
    // Start moving UP
 ...
 * @focus Robustness
 */
TEST_F(DeskControllerUnit, Unit_StateHandler_NullInputs_HandlesSafely) {
 ...
 */
TEST_F(DeskControllerUnit, Unit_TimeControl_MockTimeUpdates) {
    DeskApp_set_time_ms(0);
 ...
 * @focus Test infrastructure reliability
 */
TEST_F(DeskControllerUnit, Unit_InternalState_CanBeInspectedAndModified) {
